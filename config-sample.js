exports.creds = {
    // Required
    identityMetadata: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration', 
    ...
    clientID: '<appId from Azure App Registration>',
    ...
    redirectUrl: 'http://localhost:4242/api/auth/callback', 
    ...
    scope: ['email', 'profile', 'offline_access', 'openid', 'https://graph.microsoft.com/User.Read'],
